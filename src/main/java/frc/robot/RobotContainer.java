...
public class RobotContainer {
    ...
    public double getLeftY() {
        return (isDriverStation) ? -driverStationJoystick.getRawAxis(0) : Math.sqrt(-xboxSubsystem.getController().getLeftY());
    }

    public double getLeftX() {
        return (isDriverStation) ? driverStationJoystick.getRawAxis(1) : Math.sqrt(-xboxSubsystem.getController().getLeftX());
    }

    public double getRightY() {
        return (isDriverStation) ? -driverStationJoystick.getRawAxis(2) : Math.sqrt(-xboxSubsystem.getController().getRightY());
    }

    public double getRightX() {
        return (isDriverStation) ? driverStationJoystick.getRawAxis(3) : Math.sqrt(-xboxSubsystem.getController().getRightX());
    }
