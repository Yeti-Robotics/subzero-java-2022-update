...
public class DriveForDistanceHighPIDCommand extends PIDCommand {
  private DrivetrainSubsystem drivetrainSubsystem;
  private double encoderGoal;
  private ShiftingGearSubsystem shiftingGearSubsystem;
  /** Creates a new DriveForDistancePID. */
  public DriveForDistanceHighPIDCommand(DrivetrainSubsystem drivetrainSubsystem, double encoderGoal) {
    super(
